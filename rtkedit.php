...
<?php
    ...
    $id = $_GET['GetID'];
    $query = " SELECT * FROM rtkservicecontract WHERE id='".$id."'";
...
<fieldset>
    <br>
    <form action="includes/rtkupdate.php?id=<?php echo $id;?>" method="POST">
        <div class="row">
        ...
        <div class="row">
            ...
            <div><label for="passwords">Passwords -</label>
            <input autocomplete="off" type="text" name="passwords" value="<?php echo $passwords ?>"></div>
        ...
        <input type="submit" value="Change" name="rtkupdate">
    </form>
</div>
</fieldset>
</body>
